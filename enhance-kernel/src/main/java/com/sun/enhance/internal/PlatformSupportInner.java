...
import com.sun.enhance.internal.util.SystemUtil;
...
public final class PlatformSupportInner {
    ...
    static {
        ...
        try {
            Class<?> cls = SystemUtil.loadClass("sun.nio.ch.DirectBuffer", false, SystemUtil.getClassLoader(PlatformSupportInner.class));
